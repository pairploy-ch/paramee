...
export default function FeaturedSection({
  ...
  properties: Property[];
  /** Omit for the generic "ทรัพย์แนะนำ" section; pass a type to render the split-by-type variant. */
  kind?: "house" | "condo" | "land";
}) {
  const { t } = useTranslation();
  const badge = kind
    ? { house: t.home.featuredHouseBadge, condo: t.home.featuredCondoBadge, land: t.home.featuredLandBadge }[kind]
    : t.home.featuredBadge;
  const heading = kind
    ? {
        house: t.home.featuredHouseHeading,
        condo: t.home.featuredCondoHeading,
        land: t.home.featuredLandHeading,
      }[kind]
